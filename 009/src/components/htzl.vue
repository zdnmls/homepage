<template>
    <Htmb>
        <div style="padding: 20px 100px">
            <h2 style="padding: 20px 0 30px">个人信息更新</h2>
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
            <FormItem label="网站名称" prop="name">
                <Input v-model="formValidate.name" placeholder="请输入网站名..."></Input>
            </FormItem>
            <FormItem label="座右铭" prop="desc">
                <Input v-model="formValidate.desc" placeholder="请输入座右铭（一句话）"></Input>
            </FormItem>
            <FormItem label="姓名" prop="gjz">
                <Input v-model="formValidate.gjz" placeholder="请输入您的真实姓名"></Input>
            </FormItem>
            <FormItem label="生日">
                <Row>
                    <Col span="11">
            ...
            <FormItem label="个人简介" prop="clas">
                <Input v-model="formValidate.clas" placeholder="请输入个人简介（一句话）"></Input>
            </FormItem>
            <FormItem label="页脚" prop="urls">
                <Input v-model="formValidate.urls" placeholder="请输入页脚语句（一句话）"></Input>
            </FormItem>


            <FormItem label="个人照片" prop="imgs">
                <form @submit.prevent="submit" ref="form">
                    <div style="display: flex;align-items: center">
                        <div class="form-group">
                            <input type="file" name="f" class="form-control-file" id="exampleFormControlFile1">
                        </div>
                        <Input disabled v-model="formValidate.imgs" placeholder="提交前请先上传照片（务必）" style="width: 300px;margin-right: 20px"></Input>
        ...
        data () {
            return {
                ...
                ruleValidate: {
                    ...
                    urls: [
                        { required: true, message: '页脚不能为空！', trigger: 'blur' }
                    ],
                    imgs: [
